...
return [
    'modules' => [
        ...
        'Mageplaza_Sitemap' => 1,
        'Mageplaza_Smtp' => 1,
        'Mageplaza_TwitterWidget' => 1,
        'Meetanshi_AdvanceContact' => 1,
        'Mirasvit_Core' => 1,
        'Mirasvit_Misspell' => 1,
        'Mirasvit_Report' => 1,
        'Amasty_Shopby' => 1,
        ...
        'Redstage_NanoGallery' => 1,
        'Redstage_NotifyAlert' => 1,
        'Redstage_ProductBadges' => 1,
        'Redstage_ReleaseCalendar' => 1,
