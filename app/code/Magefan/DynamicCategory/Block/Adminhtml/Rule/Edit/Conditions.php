...
namespace Magefan\DynamicCategory\Block\Adminhtml\Rule\Edit;
    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    const TEXT_JS_FORM_OBJECT = 'mfdynamiccategory_rule_formrule_conditions_fieldset_';
    /**
     * Core registry
     *
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_serialized_fieldset', $formName = 'mfdynamiccategory_rule_form')
    {
        ...
        $fieldset = $form->addFieldset(
            ...
            [
                'legend' => __(
                    'Product`s Conditions (while the conditions are blank rule will be ignored)'
                )
            ]
        )->setRenderer(
            $renderer
